...
import { Language, TransportCategory, UserType } from '@app/constants/enum.contant'

export const LOG_LANGS = [Language.Chinese, Language.English]
export const LOG_TYPE = [UserType.URL, UserType.RELOAD, UserType.AROUND, UserType.OTHER]
...
export const MechanismTypes = [MetricsName.CS, MetricsName.JS, MetricsName.REACT, MetricsName.RS, MetricsName.UJ]
