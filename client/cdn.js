const envLib = {
  development: {
    ...
    'mobx-react-lite': 'mobxReactLite@https://cdn.jsdelivr.net/npm/mobx-react-lite@3.2.2/dist/mobxreactlite.umd.development.js',
  },
  production: {
    ...
    'mobx-react-lite': 'mobxReactLite@https://cdn.jsdelivr.net/npm/mobx-react-lite@3.2.2/dist/mobxreactlite.umd.production.min.js',
  },
}
const lib = {
...
module.exports = {
  ...
  esm: (name, mode, version) => {
    const url = `https://esm.sh/${name}${version ? '@' + version : ''}${mode === 'development' ? '?dev' : ''}`
    console.log(url)
    return url
  },
}